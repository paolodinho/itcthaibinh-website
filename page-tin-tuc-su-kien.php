<?php
/** Tin tức – Sự kiện (liệt kê bài viết + lọc danh mục) */
if (!defined('ABSPATH')) exit;
get_header();
itc_page_hero('Tin tức – Sự kiện', 'Cập nhật mới nhất về du học, học bổng, ngoại ngữ và hoạt động của ITC.', '', true);
$paged = max(1, get_query_var('paged'), get_query_var('page'));
$q = new WP_Query(['post_type'=>'post','posts_per_page'=>9,'paged'=>$paged,'ignore_sticky_posts'=>true]);
?>
