...
<section class="section">
  <div class="wrap">
    ...
    <div class="section-head reveal" style="margin-top:64px">
      <span class="kicker">Hệ thống cơ sở</span>
      <h2>3 cơ sở ITC tại Hưng Yên - bản đồ &amp; chỉ đường</h2>
      <p class="lead">Mỗi cơ sở có bản đồ riêng. Bấm "Chỉ đường" để Google Maps dẫn đường tận nơi từ vị trí của bạn - chọn cơ sở gần nhất để tới tư vấn trực tiếp &amp; kiểm tra trình độ miễn phí.</p>
    </div>
    <div class="branches reveal" data-delay="1">
      <?php foreach (itc_branches() as $i => $b):
      ...
      <article class="branch">
        ...
        <div class="branch__info">
          ...
          <?php else : ?>
          <p class="branch__dir branch__dir--empty"><?php echo itc_icon('check',15); ?> Bấm <b>"Chỉ đường"</b> để Google Maps dẫn đường tận nơi tới <?php echo esc_html($b['name']); ?> từ vị trí hiện tại của bạn.</p>
          <?php endif; ?>
