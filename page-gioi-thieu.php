  ...
  <div class="wrap about__grid" style="display:grid;grid-template-columns:5fr 6fr;gap:clamp(36px,5vw,72px);align-items:center">
    ...
    <div class="reveal" data-delay="1">
      ...
      <ul class="flist" style="margin-top:24px">
        ...
        <li><span class="fico"><?php echo itc_icon('network',22); ?></span><div><b>Mạng lưới đối tác rộng</b><p>Hơn 50 trường tại Đài Loan &amp; Nhật Bản với nhiều suất học bổng.</p></div></li>
      </ul>
    </div>
  </div>
</section>
...
<section class="section section--alt" style="padding-top:0">
  <div class="wrap" style="padding-top:clamp(56px,7vw,90px)">
    <div class="figrow reveal">
      <?php for ($n=1; $n<=4; $n++):
        $defs = [1=>['10','+','Năm kinh nghiệm'],2=>['2000','+','Học viên du học'],3=>['98','%','Tỉ lệ đậu visa'],4=>['50','+','Trường đối tác']];
...
<section class="section">
  <div class="wrap">
    ...
    <div class="icards reveal" data-delay="1" style="grid-template-columns:repeat(3,1fr)">
      ...
      <div class="icard"><span class="icard__ico"><?php echo itc_icon('medal',22); ?></span><div><b>Kinh nghiệm 10+ năm</b><p>Hơn 2.000 học viên, tỉ lệ đậu visa cao, 50+ trường đối tác.</p></div></div>
